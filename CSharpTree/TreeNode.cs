...
namespace CSharpTree
{
    public class TreeNode<T> : IEnumerable<TreeNode<T>>
    {
        ...
        {
            if (found.IsLeaf)
                return new Tuple<bool, string>(ElementsIndex.Remove(found), "Leaf Removed");

            foreach (TreeNode<T> foundChild in found.Children)
            {
                found.Parent.Children.Add(foundChild);
            }
